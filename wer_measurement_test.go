...
func TestWERMeasurement_FixedCorpusAgainstFakeASRBackedPipeline(t *testing.T) {
	...
	if len(entries) < 35 {
		t.Fatalf("qa.FixedCorpus() returned %d entries, want at least 35", len(entries))
	}
